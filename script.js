//Z is total number of notes in a particular tuning system, for example Z=12 in 12TET system. 
//X is the number of notes in a particular scale of the system, for example X=7 for heptatonic scales. X=5 for the pentatonic scales.
...
//beyond the initial elimination the remaining scales contain many identical pairs, triplets, quartets, etc... For example 022323 is functionally identical, by inversion, to 032322, 032232, 023232, and 023232. This means that both the major and minor pentatonic scales are better understood as modes of the same scale. Similar to the Major and Natural Minor heptatonic Scales.
//As of now there doesn't seem to be a generalized formula for finding these matches. Brute force searching has resulted in 66 pentatonic scales, with no inversions, in the 12TET system. 
